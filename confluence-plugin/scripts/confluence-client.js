...
class ConfluenceClient {
  constructor() {
    ...
    this.host = resolveEnvValue(process.env.CONFLUENCE_HOST);
    this.email = resolveEnvValue(process.env.CONFLUENCE_EMAIL);
    this.apiToken = resolveEnvValue(process.env.CONFLUENCE_API_TOKEN);
